        ...
        <header className="bg-[#ff5200]">
            ...
            <div className="flex justify-between container mx-auto py-8 px-8">
                ...
                <div className="text-white text-base font-bold flex gap-15 items-center">
                    ...
                    <a className="border border-black bg-black py-3 px-4 rounded-2xl" href = "">Sign in</a>
                </div>
            </div>
            ...
            <div className="pt-16 pb-8 relative">
                ...
                <div className="max-w-[70%] container mx-auto flex justify-center gap-5 mt-10">
                    ...
                    <input className="bg-white w-[45%] text-xl px-6 py-4 rounded-2xl" placeholder="Search for restaurant and items for more"></input>
                </div>
            </div>
