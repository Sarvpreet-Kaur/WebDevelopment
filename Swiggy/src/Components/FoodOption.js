...
export default function FoodOption(){
    ...
    return (
        <div className="w-[80%] container mx-auto mt-20 relative">
            ...
            {/* Left Button */}
            {showLeft && (
                <button onClick={scrollLeft} className="absolute -left-5 top-1/2 -translate-y-1/2  bg-white shadow-md rounded-full w-10 h-10 z-10 hover:scale-110 transition">
                    <ChevronLeft size={22} />
                </button>
            )}
            ...
            <div ref={scrollRef} className=" container mx-auto mt-20 grid grid-rows-2 grid-flow-col gap-4 overflow-x-auto overflow-y-hidden auto-cols-max h-100 no-scrollbar">
            ...
            {/* RIGHT BUTTON */}
            {showRight && (
                <button onClick={scrollRight} className="absolute -right-5 top-1/2 -translate-y-1/2 bg-white shadow-md rounded-full w-10 h-10 z-10 hover:scale-110 transition">
